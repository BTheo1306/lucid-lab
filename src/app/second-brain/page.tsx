...
export const metadata: Metadata = {
  ...
  description:
    'On installe Claude et on le connecte à ce que votre entreprise sait déjà : offres, process, clients. Base de connaissance, connexion à vos outils, deux automatisations et formation, en 2 jours, à distance.',
