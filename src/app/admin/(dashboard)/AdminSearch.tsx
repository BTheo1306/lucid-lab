...
export function AdminSearch() {
  ...
  return (
    <form onSubmit={submitSearch} className="hidden min-w-0 items-center gap-2 rounded-md border border-zinc-200 bg-white px-3 py-2 text-sm text-zinc-500 md:flex md:w-[360px]">
