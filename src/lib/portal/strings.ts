...
export const portalStrings = {
  ...
  requests: {
    title: 'Échanges',
    description: 'Posez vos questions, envoyez vos demandes et répondez à celles de Lucid-Lab.',
    ...
    created: 'Votre demande a bien été envoyée. Nous revenons vers vous rapidement.',
  ...
  info: {
    ...
    websiteUrl: 'Site web',
    save: 'Enregistrer',
    saved: 'Informations mises à jour. Merci !',
    saveFailed: "Les informations n'ont pas pu être enregistrées. Réessayez ou écrivez-nous.",
