...
Profile created (Jules cleared the CAPTCHA + authority checkbox). Step 2 filled: name Lucid-Lab, language FR, team size 3, address + phone (Jules), website, email, and 2 services (Intelligence Artificielle; Développement de Logiciel) each with a description and a 3000 EUR starting-price floor for lead-matching (adjust to preference). Account created; profile editor filled by Claude (slogan, full FR description, languages FR+EN, founded 2026). DONE: Jules uploaded the logo and published. Profile LIVE at app.sortlist.com/lucid-lab (profile quality 48%, "profil en ligne 6/6").

### Clutch (vendor.clutch.co onboarding) — 2026-06-22
Jules signed in. Step 1 goal: generate leads. Step 2 company info filled and saved: name, website, sales email, scheduling link (Audit Flash), founding year 2026, team 2-9, tagline "Systèmes IA métier en production", English description. Jules set pricing (step 3, hourly rate guidance: 100-149 USD per the 650 EUR/day rate) and location (step 4). Claude filled step 5 service lines: AI Development 40%, AI Agents 35%, Generative AI 25% (= 100%). DONE: profile completed and submitted; under review by Clutch (status Unpublished until review passes, normal for new free profiles).
